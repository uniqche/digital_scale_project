...
while True:
    ...
    if command:
        ...
        elif command.startswith(b"CAL:") and len(command) == 6:
            print("CAL command recognized")

            calibration_weight = int.from_bytes(command[4:6], byteorder='little')

            print("Calibration weight received:", calibration_weight)
